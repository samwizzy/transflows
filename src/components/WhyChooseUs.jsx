...
import { Icon2, Icon3, Icon4, Icon5, Icon6, Iconn, PlaneBg } from "../TransflowImages";
import "../styles/HomeStyles.css";

const WhyChooseUs = () => {
  return (
    <div className="py-16 w-full flex mt-8">
      <div className="bg-[#091242] w-1/2 flex justify-center items-center">
        <img src={PlaneBg} alt="" className="WhyUs-Img" />
      </div>
      ...
      <div className="bg-[#F4F4F4] w-1/2 justify-center items-center flex flex-col">
        <div className="w-96  ">
          <div className="flex ">
            ...
            <p className="text-black bg-[#E8E8E880] w-28 text-sm p-1">Why Choose</p>
          </div>
          <h1 className="font-bold text-2xl mt-2">We create opportunity to reach potential</h1>
          <p className="text-[#666C89] text-sm mt-3">
            Leverage agile frameworks to provide a robust synopsis for strategy foster collaborative thinking to further
