        ...
        <div className="border-t-2 border-[#D6D6D6] mt-7">
          <div className="flex flex-col">
            <div className="flex gap-2 justify-center items-center mt-4">
              ...
              <div className="w-2 self-stretch border-r border-[#D6D6D6] mt-10 mr-6" />

              <div className="mt-12">
                <h1 className="text-xl font-bold text-[1C1F35]">Inland freight a worthy solution for your business</h1>
                <p className="mt-2 text-[#666C89] mb-4">
            ...
            <div className="flex items-center">
              ...
              <div className="mt-12">
                <h1 className="text-xl font-bold text-[#FFBE34]">
            ...
            <div className="flex items-center mb-16">
              ...
              <div className="w mt-12">
                <h1 className="text-xl font-bold text-[#1C1F35]">Five things you should have ready for your broker</h1>
                <p className="mt-2 text-[#666C89] mb-4">
                  We are dedicated in creating added value for our customers by implementing modern technology in our
                  work.{" "}
                </p>
            ...
            <div className="border-b-2 border-[#D6D6D6]" />
